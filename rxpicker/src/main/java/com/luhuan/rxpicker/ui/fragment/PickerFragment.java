package com.luhuan.rxpicker.ui.fragment;
...
import com.luhuan.rxpicker.base.AbstractFragment;
import com.luhuan.rxpicker.bean.FolderClickEvent;
import com.luhuan.rxpicker.bean.ImageFolder;
import com.luhuan.rxpicker.bean.ImageItem;
import com.luhuan.rxpicker.ui.PreviewActivity;
import com.luhuan.rxpicker.ui.adapter.PickerFragmentAdapter;
import com.luhuan.rxpicker.ui.fragment.mvp.PickerFragmentContract;
import com.luhuan.rxpicker.ui.fragment.mvp.PickerFragmentPresenter;
import com.luhuan.rxpicker.utils.CameraHelper;
import com.luhuan.rxpicker.utils.DensityUtil;
import com.luhuan.rxpicker.utils.PickerConfig;
import com.luhuan.rxpicker.utils.RxBus;
...
import com.luhuan.rxpicker.widget.PopWindowManager;
...
public class PickerFragment extends AbstractFragment<PickerFragmentPresenter> implements PickerFragmentContract.View, View.OnClickListener {
    ...
    private Subscription folderClicksubscribe;
    private Subscription imageItemsubscribe;
    ...
    private void initObservable() {
        ...
        folderClicksubscribe = RxBus.singleton().toObservable(FolderClickEvent.class)
        ...
        imageItemsubscribe = RxBus.singleton().toObservable(ImageItem.class)
    ...
    public void onDestroy() {
        ...
        if (!folderClicksubscribe.isUnsubscribed()) {
            folderClicksubscribe.unsubscribe();
        }

        if (!imageItemsubscribe.isUnsubscribed()) {
            imageItemsubscribe.unsubscribe();
        }
    }
